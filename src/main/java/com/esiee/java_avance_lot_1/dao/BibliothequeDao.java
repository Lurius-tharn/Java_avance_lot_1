...
public class BibliothequeDao {
    ...
    private static final String USER_CREDS_CHECK_QUERY = "SELECT * FROM ja_library.user WHERE username = ? AND password = ?";
    private static final String USER_UNIQUE_QUERY = "SELECT * from ja_library.user WHERE username = ?";
    private static final String USER_ROLE_QUERY = "SELECT role FROM ja_library.user WHERE username = ?";
    private static final String CREATE_USER_QUERY = "INSERT INTO ja_library.user(username, password, role, mail) VALUES (?, ?, ?, ?)";
    private static final String UPDATE_MAIL_QUERY = "UPDATE ja_library.user SET password = ? WHERE mail = ?";
    ...
    public boolean checkUserCreds(String username, String password) throws SQLException {
        PreparedStatement preparedStatement = null;
        ResultSet rs = null;
        ...
        try (Connection connection = DriverManager
            ...
            preparedStatement = connection.prepareStatement(USER_CREDS_CHECK_QUERY);
    ...
    public int getUserRole(String username) throws SQLException {
        ...
        try (Connection connection = DriverManager
            ...
            preparedStatement = connection.prepareStatement(USER_ROLE_QUERY);
    ...
    public boolean checkUserUnique(String username) throws SQLException {
        ...
        try (Connection connection = DriverManager
            ...
            preparedStatement = connection.prepareStatement(USER_UNIQUE_QUERY);
    ...
    public int createUser(String username, String password, int role, String mail) throws SQLException {
        PreparedStatement preparedStatement = null;
        int res = 0;
        boolean isUserExists = false;
        ...
        try (Connection connection = DriverManager
            ...
            try {
                isUserExists = checkUserUnique(username);
            } catch (SQLException e) {
                throw new RuntimeException(e);
            }
    ...
    public int updateMail(String mail, String newPassword) throws SQLException {
        PreparedStatement preparedStatement = null;
        int res = 0;
        ...
        try (Connection connection = DriverManager
            ...
            preparedStatement = connection.prepareStatement(UPDATE_MAIL_QUERY);
